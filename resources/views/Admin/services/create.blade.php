                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group mt-3">
                                                <textarea name="service_detail" rows="4" class="form-control no-resize" placeholder="Service Description..."></textarea>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group c_form_group mt-3">
                                                ...
                                                <select class="form-control show-tick" name="service_group" required>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group c_form_group mt-3">
                                                ...
                                                <select class="form-control show-tick" name="location_name" required>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group c_form_group mt-3">
                                                ...
                                                <input name="service_availability" class="form-control" type="text">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group c_form_group mt-3">
                                                <label>Payment Method</label>
                                                <input name="service_payment_method" class="form-control" type="text">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group c_form_group mt-3">
                                                <label>Business Hours</label>
                                                <input name="service_business_hour" class="form-control" type="text">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group c_form_group mt-3">
                                                <label>Email</label>
                                                <input name="service_email" class="form-control" type="email">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group c_form_group mt-3">
                                                <label>Phone</label>
                                                <input name="service_phone" class="form-control" type="text">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group c_form_group mt-3">
                                                <label>Number of Employees</label>
                                                <input name="service_employee_no" class="form-control" type="number">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group c_form_group mt-3">
                                                <label>Years of Experience</label>
                                                <input name="service_period_of_existence" class="form-control" type="number">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
