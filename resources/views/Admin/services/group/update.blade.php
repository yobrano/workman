                            ...
                            <div
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="{{ route('admin.groups.service') }}">Services</a>
                                        </li>
                                ...
                                <form method="POST" action="{{route('admin.update.project',$project->id)}}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6 col-sm-10">
                                            <input  name="project_name" type="text" class="form-control" id="inputEmail3"
                                                placeholder="Enter Name" value="{{$project->project_name}}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Detail</label>
                                        <div class="col-md-6 col-sm-10">
                                            <textarea name="project_detail" rows="4"  class="form-control" >{{$project->project_detail}}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6 col-sm-10">
                                            <img src="{{asset("storage/".$project->project_image_path)}}"  class="w-100" alt="project-image"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6 col-sm-10">
                                            <input type="file" class="dropify" name="project_image_path" accept=".png, .jpg, .jpeg">
                                        </div>
                                    </div>
                                    <div class="form-group row">
