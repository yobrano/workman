    ...
    <div class="modal fade" id="addPrpject" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.store.groups.service') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="form-group c_form_group">
                            <label> Title</label>
                            <div class="form-line">
                                <input type="text" class="form-control" placeholder="Group Title" name="project_name">
                            </div>
                        </div>
                        <div class="form-group c_form_group">
                            <label> Group Image</label>
                            <div class="form-line">
                                <input type="file" name="project_image_path" class="form-control" placeholder="Group Image" accept=".png, .jpg, .jpeg">
                            </div>
                        </div>
                        <div class="form-group c_form_group">
                            <label>Description</label>
                            <div class="form-line">
                                <textarea name="project_detail" rows="4" class="form-control no-resize" placeholder="Group Description..."></textarea>
                            </div>
                        </div>
                    </div>
