                                ...
                                <form>
                                    <div class="input-group">
                                        <input type="button" class="btn btn-primary theme-bg gradient"
                                            value="Create Project" data-toggle="modal" data-target="#addPrpject" />
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="defaultModalLabel">Add Project</h5>
                </div>
                <form action="{{ route('admin.store.project') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="form-group c_form_group">
                            <label> Title</label>
                            <div class="form-line">
                                <input type="text" class="form-control" placeholder="Project Title" name="project_name">
                            </div>
                        </div>
                        <div class="form-group c_form_group">
                            <label> Project Image</label>
                            <div class="form-line">
                                <input type="file" name="project_image_path" class="form-control" placeholder="Project Image" accept=".png, .jpg, .jpeg">
                            </div>
                        </div>
                        <div class="form-group c_form_group">
                            <label>Description</label>
                            <div class="form-line">
                                <textarea name="project_detail" rows="4" class="form-control no-resize" placeholder="Project Description..."></textarea>
                            </div>
                        </div>
                    </div>
