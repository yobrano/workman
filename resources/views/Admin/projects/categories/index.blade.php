                                ...
                                <form>
                                    <div class="input-group">
                                        <input type="button" class="btn btn-primary theme-bg gradient"
                                            value="Create Category" data-toggle="modal" data-target="#addPrpject" />
    ...
    <div class="modal fade" id="addPrpject" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.store.category.project') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="form-group c_form_group">
                            <label> Title</label>
                            <div class="form-line">
                                <input type="text" class="form-control" placeholder="Category Title" name="category_name">
                            </div>
                        </div>
                        <div class="form-group c_form_group">
                            <label> Category Image</label>
                            <div class="form-line">
                                <input type="file" name="category_image" class="form-control" placeholder="Category Image" accept=".png, .jpg, .jpeg">
                            </div>
                        </div>
                        <div class="form-group c_form_group">
                            <label>Description</label>
                            <div class="form-line">
                                <textarea name="category_description" rows="4" class="form-control no-resize" placeholder="Category Description..."></textarea>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        $(function() {
            ...
            var table = $('.yajra-datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.get.categories.project') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex'
                    },
